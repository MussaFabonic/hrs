                    ...
                    <form action="#" method="post" class="">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="date" id="fromdte" name="fromdte" placeholder="From Date" value="<?php echo $_SESSION['dets']['fromdte']?>" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                                <div class="input-group-addon"><i class="fa fa-asterisk"></i></div>
                                <input type="date" id="todte" name="todte" placeholder="To Date" value="<?php echo $_SESSION['dets']['todte']?>" class="form-control">
                            </div>
                        </div>
                        <div class="form-actions form-group"><a type="submit" class="btn btn-success btn-sm" onClick="submitLeaveForm()">Save</a>  <a type="submit" class="btn btn-danger btn-sm" onClick="back()">Back</a></div>
                    </form>
                </div>
            </div>
        </div>
